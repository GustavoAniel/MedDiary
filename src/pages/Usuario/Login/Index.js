...
import { NativeBaseProvider, Box, ScrollView, Stack, Input, FormControl, Divider, Center, Button, Image, Alert, VStack, HStack, CloseIcon, IconButton, Modal, Spinner, Heading } from "native-base";
        ...
        <Box style={[style.background]} bg={gradient}> 
            <Box style={[style.boxForm]} p={5} rounded={5} >
                ...
                <FormControl>
                    <Stack mx="4" safeArea space={10}>
                        ...
                        <Box alignItems="center">
                            <Button backgroundColor={'transparent'} style={[style.btnCad]} onPress={() => navigate('Cadastrar_Usuario')}>Cadastrar</Button>
                        </Box>
                    </Stack>
                </FormControl>
            ...
            <Modal isOpen={carregando}>
                    <HStack space={2} justifyContent="center">
                        <Spinner color="white" accessibilityLabel="Loading posts" size={40}/>
                        <Heading color="white" fontSize={40}>Carregando</Heading>
                    </HStack>
            </Modal>
        </Box>
    )
